...
export function LoadingProductsCart() {
  return (
    <div className="flex h-40 w-full animate-pulse items-start gap-4 overflow-hidden rounded bg-white shadow-2xl">
      ...
      <div className="flex h-full w-full items-start justify-between py-3">
        ...
        <div className="flex h-full w-[130px] items-center justify-center gap-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-bg-secondary"></div>
          <div className=""></div>
          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-bg-secondary"></div>
        </div>
      </div>
